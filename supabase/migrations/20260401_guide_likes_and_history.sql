...
-- NEW FEATURES:
--
--  1. guide_likes table — tracks per-user like/dislike on guides
--     - Users cannot like/dislike their own guides (enforced in app)
--     - Each user can only have one reaction per guide (unique constraint)
--
--  2. admin_guide_history_hidden — soft-delete flag so admin can
--     "delete" a guide from their History tab without removing the
--     actual guide row from the database.
-- ================================================================
