...
import { ChevronRight, Edit2, Settings, Plus } from "lucide-react";
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-6 py-8">
        ...
        <section className="flex flex-col md:flex-row gap-8 mb-16 items-start border-b border-border pb-12">
          <div className="flex-1">
            ...
            <div className="mt-6 flex flex-wrap gap-4 items-center">
              <button className="bg-primary text-primary-foreground px-6 py-2 font-mono text-xs font-bold uppercase tracking-widest hover:brightness-110 transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                + Create a Guide
              </button>
            </div>
          </div>
        ...
        <div className="flex justify-between items-end mb-8">
          ...
          <span className="font-mono text-[10px] text-muted-foreground font-bold uppercase tracking-widest">
            68 Categories Loaded
          </span>
        </div>

        {/* 5. LOGO GRID (SEPARATED CARDS) */}
